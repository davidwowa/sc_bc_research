...
RUN mkdir app
RUN git clone https://github.com/erlang/rebar3 && cd /rebar3 && ./bootstrap && cd /rebar3/_build/default/bin && ./rebar3 local install && chmod a+x /rebar3/_build/default/bin/rebar3
